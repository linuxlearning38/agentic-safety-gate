...
def build_cases() -> list[dict]:
    ...
    cases = [
        ...
        _case("What is the capital of France?", **knowledge, contains=["Paris"]),
        _case("What is 2+2?", **knowledge, contains=["4"]),
        _case("Explain photosynthesis", **knowledge, contains=["light energy"]),
        _case("What is machine learning?", **knowledge, contains=["data"]),
        _case("TCP vs UDP", **knowledge, contains=["TCP", "UDP"]),
        _case("What is server?", **knowledge, contains=["server"]),
